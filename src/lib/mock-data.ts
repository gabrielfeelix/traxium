...
export const motoristas: Motorista[] = [
  ...
  // Motoristas dos subcontratados. Existiam só como string dentro de
  // `motoristasAutorizados` — não davam para consultar competência, nem para
  // vincular por id. A Fase 9 transformou aquelas listas em tabela de vínculo,
  // e vínculo aponta para cadastro, não para um nome digitado.
  {
    id: "m-007",
    nome: "José A. Ferreira",
    cpf: "***.876.543-**",
    tipo: "Subcontratado",
    telefone: "(66) 9 9812-3344",
    cnh: { numero: "********", categoria: "E", vencimento: "2027-05-19" },
    certificacoes: [{ nome: "MOPP", status: "Válida", vencimento: "2027-03-11" }],
    totalViagens: 38,
    conformidadeMedia: 88.2,
    ultimaViagem: "—",
    cidade: "Rondonópolis",
    uf: "MT",
    status: "Ativo",
  ...
  },
  {
    ...
    cpf: "***.345.678-**",
    tipo: "Subcontratado",
    telefone: "(66) 9 9633-8890",
    cnh: { numero: "********", categoria: "E", vencimento: "2026-12-02" },
    certificacoes: [{ nome: "MOPP", status: "Válida", vencimento: "2026-09-28" }],
    totalViagens: 61,
    conformidadeMedia: 90.1,
    ultimaViagem: "—",
    cidade: "Rondonópolis",
    uf: "MT",
    status: "Ativo",
  ...
  },
  {
    ...
    cpf: "***.789.012-**",
    tipo: "Subcontratado",
    telefone: "(66) 9 9277-4415",
    cnh: { numero: "********", categoria: "E", vencimento: "2027-09-14" },
    certificacoes: [{ nome: "MOPP", status: "Válida", vencimento: "2027-01-30" }],
    totalViagens: 24,
    conformidadeMedia: 86.7,
    ultimaViagem: "—",
    cidade: "Sorriso",
    uf: "MT",
    status: "Ativo",
